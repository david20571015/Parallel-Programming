...
void _pp_vgt_float(__pp_mask &maskResult, __pp_vec_float &veca, __pp_vec_float &vecb, __pp_mask &mask) {
  _pp_vgt<float>(maskResult, veca, vecb, mask);
}
void _pp_vgt_int(__pp_mask &maskResult, __pp_vec_int &veca, __pp_vec_int &vecb, __pp_mask &mask) {
  _pp_vgt<int>(maskResult, veca, vecb, mask);
}
...
void _pp_vlt_float(__pp_mask &maskResult, __pp_vec_float &veca, __pp_vec_float &vecb, __pp_mask &mask) {
  _pp_vlt<float>(maskResult, veca, vecb, mask);
}
void _pp_vlt_int(__pp_mask &maskResult, __pp_vec_int &veca, __pp_vec_int &vecb, __pp_mask &mask) {
  _pp_vlt<int>(maskResult, veca, vecb, mask);
}
...
void _pp_veq_float(__pp_mask &maskResult, __pp_vec_float &veca, __pp_vec_float &vecb, __pp_mask &mask) {
  _pp_veq<float>(maskResult, veca, vecb, mask);
}
void _pp_veq_int(__pp_mask &maskResult, __pp_vec_int &veca, __pp_vec_int &vecb, __pp_mask &mask) {
  _pp_veq<int>(maskResult, veca, vecb, mask);
}
...
void addUserLog(const char *logStr) { PPLogger.addLog(logStr, _pp_init_ones(), 0); }
